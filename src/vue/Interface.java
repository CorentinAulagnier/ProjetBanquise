...
public class Interface extends Application {
	...
	public void start(Stage primaryStage) {
		...
		*/
		...
		primaryStage.getIcons().add(new Image(model.Proprietes.FAVICON_PATH));
		primaryStage.setTitle("Pinguouins");
		primaryStage.sizeToScene();
		primaryStage.show();
		
		
		/* Gestion du redimensionnnement 	*/
	...
	/**
	 * Met à jour l'echelle au redimensionnement en largeur
	 * @param primaryStage
	...
	/**
	 * Met à jour l'echelle au redimensionnement en hauteur
	 * @param primaryStage
	 * @param gestionnaireEcransFXML
